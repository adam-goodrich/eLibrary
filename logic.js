...
titleDiv.addEventListener("input", function (event) {
  if (!titleDiv.checkValidity()) {
    titleDiv.setCustomValidity("Please enter the book title.");
  } else {
    titleDiv.setCustomValidity("");
  }
});
...
submit.addEventListener("click", function (e) {
  if (
    !titleDiv.checkValidity() |
    !authorDiv.checkValidity() |
    !pageDiv.checkValidity()
  ) {
    alert("Please fill out required fields (highlighted red)");
  } else {
...
function addBookToLibrary(title, author, pages, read, image) {
  if (image == "") {
    image =
      "https://png.pngtree.com/png-vector/20190411/ourlarge/pngtree-vector-book-icon-png-image_926280.jpg";
  }
...
function build() {
  ...
  for (let i = 0; i < myLibrary.length; i++) {
    ...
    books.innerHTML = `
        ...
        <img src="${
          myLibrary[i].image
        }" style="width:9em;height:15em;" onerror="this.src='https://png.pngtree.com/png-vector/20190411/ourlarge/pngtree-vector-book-icon-png-image_926280.jpg'">
